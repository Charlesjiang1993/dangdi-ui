window.onload=function(){
    ...
    for(var i=0;i<aLeftDiv.length;i++){    
        ...
        aLeftDiv[i].onclick = function(){
            ...
            switch(this.index){
                case 0:num=0;break;case 1:num=4 ;break;case 2:num=10 ;break;case 3:num=14 ;break;case 4:num=19 ;break;default :num=20;
            }
            oIframe.setAttribute("src","/src/html/"+iframe_arr[num]); 
    ...
    for(var j=0;j<aLi.length;j++){
        ...
        aLi[j].onclick=function(){
            ...
            oIframe.setAttribute("src","/src/html/"+iframe_arr[this.index]); 
        }
    }   
